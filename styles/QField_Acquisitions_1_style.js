...
var style_QField_Acquisitions_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 9.4 + size, points: 6,
        ...
        image: new ol.style.RegularShape({radius: 3.84546 + size, points: 6,
